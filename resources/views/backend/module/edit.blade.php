                        ...
                        <div class="x_content">
                            <form action="{{route('module.update',$module->id)}}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$module->name}}" id="name" name="name" placeholder="Enter name">
                                    <span class="error"><b>
                                         @if($errors->has('name'))
                                                {{$errors->first('name')}}
                                            @endif</b>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$module->module_key}}" id="module_key" name="module_key" placeholder="Enter module_key">
                                    <span class="error"><b>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$module->module_url}}" id="module_url" name="module_url" placeholder="Enter module_url">
                                    <span class="error"><b>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$module->module_rank}}" id="module_rank" name="module_rank" placeholder="Enter module_rank">
                                    <span class="error"><b>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$module->module_icon}}" id="module_icon" name="module_icon" placeholder="Enter module_icon (eg:- fa fa-dashboard)">
                                </div>
                                <div class="form-group">
                                    ...
                                    @else
                                        ...
                                        <label for="view_sidebar"> Yes </label>
                                        <input type="radio" name="view_sidebar" id="deactive" value="0" checked="">
                                        <label for="deactive">No</label>
                                    @endif
                                </div>
                                <div class="form-group">
