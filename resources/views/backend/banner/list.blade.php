                            ...
                            <table class="table table-responsive">
                                ...
                                @foreach($banner as $m)
                                    <tr>
                                        ...
                                        <td> <img src="/images/{{$m->image}}" width="100" height="100"> </td>
                                        ...
                                        <td> {{$m->created_at}}</td>
                                        <td> {{$m->updated_at}}</td>
                                        <td><a href="{{route('banner.edit',$m->id)}}" class="btn btn-primary"><i class="fa fa-pencil"></i> Edit</a>

                                            <form action="{{route('banner.delete' ,$m->id)}}" method="post">
