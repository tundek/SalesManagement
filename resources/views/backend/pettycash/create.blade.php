            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form id="btnSave" action="{{route('petty-cash.store')}}" method="POST">
                                {{ csrf_field()}}
                                <div class="form-group">
                                    <label for="totalcash">Leave petty cash</label>
                                    <input type="number" class="form-control" id="totalcash" name="totalcash" placeholder="Enter pettycash amount">
                                    <span class="error"><b>
                                ...
                                <div class="box-footer">
                                    <button type="submit" name="btnSave" class="btn btn-primary">Leave petty Cash</button>
                                </div>
                            </form>
                         </div>
                    </div>
